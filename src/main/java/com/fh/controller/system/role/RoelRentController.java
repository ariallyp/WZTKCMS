 ...
 */
@Controller
@RequestMapping(value="/rent_role")
public class RoelRentController extends BaseController {
	
	String menuUrl = "rent_role.do"; //菜单地址(权限用)
	...
	public ModelAndView list(Page page)throws Exception{
			...
			mv.setViewName("system/rent/rent_list");
			mv.addObject(Const.SESSION_QX,this.getHC());	//按钮权限
		
		return mv;
	}
	
	@RequestMapping(value="/listRents")
	public ModelAndView listRent(Page page)throws Exception{
			ModelAndView mv = this.getModelAndView();
			PageData pd = new PageData();
			pd = this.getPageData();
	...
	public ModelAndView toAdd(Page page){
		...
		try{
			pd = this.getPageData();
			mv.setViewName("system/rent/role_add");
			mv.addObject("pd", pd);
		} catch(Exception e){
			logger.error(e.toString(), e);
		}
