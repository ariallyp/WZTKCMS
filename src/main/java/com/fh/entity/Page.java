	...
	public String getPageStr() {
		...
		if(totalResult>0){
			...
			if(currentPage==1){
				...
				sb.append("	<li><input type=\"number\" min=\"1\" max=\"999999\" value=\"\" id=\"toGoPage\" style=\"width:50px;text-align:center;float:left\" placeholder=\"页码\"/></li>\n");
			...
			sb.append("if(toPaggeVlue >999999){document.getElementById(\"toGoPage\").value=1;return;}");
