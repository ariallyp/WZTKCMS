...
import com.fh.wsdl.service.wsdlLoactionCache;
...
public class WcfApplicationService extends Service {
	...
	/**
	 * 
	 * @return returns IApplicationService
	 */
	@WebEndpoint(name = "BasicHttpBinding_IApplicationService")
	public IApplicationService getBasicHttpBindingIApplicationService() {
		return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IApplicationService"),
	...
	public IApplicationService getBasicHttpBindingIApplicationService(WebServiceFeature... features) {
		return super.getPort(new QName("http://tempuri.org/", "BasicHttpBinding_IApplicationService"),
				IApplicationService.class, features);
	}
