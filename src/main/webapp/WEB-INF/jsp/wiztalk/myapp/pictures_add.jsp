	...
	<form action="wizapp/saveFile.do" name="Form" id="Form"
		...
		<div id="zhongxin" >
			<table style="width: 95%; ">
				...
				<tr>
					<td style="padding-left: 40px; padding-top: 30px; "><input type="file"
						id="uploadfile" name="file" style="width: 350px; font-size:16px;" /></td>
						
				</tr>
				<tr>
				<td style="padding-left: 40px; padding-top: 20px; font-size:18px;" >
						APK应用请根据应用的命名名称上传，这样上传后的apk名称就是你的命名名称。
