	...
	<form action="organization/${msg }.do" name="Form" id="Form" method="post">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
					...
					<td><select class="chzn-select" name="PARENT_ID" id="PARENT_ID"
						data-placeholder="请选择父类" style="vertical-align: top;" title="父类">
							<option value=""></option>
							<option value="">无</option>
							<c:forEach items="${varList}" var="org">
								<option value="${org.ORGANIZATION_ID }"
									<c:if test="${pd.ORGANIZATION_ID==org.ORGANIZATION_ID}">selected</c:if>>${org.ORG_NAME }</option>
			...
			<tr>
				...
				<td><input type="text" name="ORG_NAME" id="NAME" value="${pd.ORG_NAME}" maxlength="32" placeholder="这里输入名称" title="名称"/></td>
			</tr>
			<tr>
