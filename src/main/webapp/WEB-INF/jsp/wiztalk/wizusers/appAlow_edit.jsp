...
<body>
	<form action="wizusers/editAppAlow.do" name="Form" id="Form" method="post">
		<input type="hidden" name="ALOW_ID" id="ALOW_ID" value="${pd.ALOW_ID}"/>
		<div id="zhongxin">
		...
		<%-- 	<tr>
			...
			<tr>
				<td style="width:70px;text-align: right;padding-top: 13px;">权限管理:</td>
