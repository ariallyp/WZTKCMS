...
<table style="width:100%;" border="0">
	<tr>
		...
		<td style="width:85%;" valign="top" >
			<iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/wizusers/listAppAlow.do" style="margin:0 auto;width:100%;height:100%;"></iframe>
		</td>
	</tr>
</table>
		...
		function zTreeOnClick(event,treeId,treeNode){
			...
			$("#treeFrame").attr("src", 'wizusers/listAppAlow.do?ORG_ID='+id);
